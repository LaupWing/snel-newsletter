...
function Pill( { tone, icon: Icon, children }: PillProps ) {
 ...
 */
function Detail( { type, row }: { type: string; row: any } ) {
    if ( 'email' === type ) {
        return (
...
export default function NodeInspector( { automationId, path, onClose }: Props ) {
