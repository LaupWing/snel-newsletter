...
const STEP_ICON = { email: Mail, wait: Clock, condition: Split, label: TagIcon };
...
function describe( step, campaigns ) {
    if ( ! step ) {
...
export default function SubscribersTab( { automation, campaigns } ) {
