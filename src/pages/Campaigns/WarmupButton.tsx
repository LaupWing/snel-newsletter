...
type LaneControlProps = {
    lane: Lane;
    state: any;
    onToggle: ( lane: string, val: boolean ) => void;
    onRestart: ( lane: string ) => void;
};

function LaneControl( { lane, state, onToggle, onRestart }: LaneControlProps ) {
...
function WarmupModal( { status, onToggle, onRestart, onClose }: WarmupModalProps ) {
...
export default function WarmupButton( { status, onToggle, onRestart }: Props ) {
