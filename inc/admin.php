...
add_action( 'admin_menu', function () {
    ...
    add_submenu_page( 'snel-newsletter', __( 'Dashboard', 'snel-newsletter' ), __( 'Dashboard', 'snel-newsletter' ), 'manage_options', 'snel-newsletter', function () { snel_newsletter_render_page( 'dashboard' ); } );
